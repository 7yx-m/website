...
const leadership = [
  {
    ...
    description: "Driving community impact and organizational strategy.",
  },
  {
    role: "SAT Math Tutor",
    org: "Independent Specialist",
    description: "Personalized algorithmic tutoring for standardized tests.",
  },
];

export const About = () => {
  return (
    <section id="about" className="py-24 px-8 md:px-24 bg-obsidian border-b border-slate-gray/30">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          >
            ...
            <div className="space-y-12">
              {education.map((edu, idx) => (
                <div key={idx} className="relative pl-6 border-l border-slate-gray/30">
                  ...
                  <p className="mt-4 text-pure-white/60 font-mono text-xs uppercase tracking-widest">{edu.grade}</p>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {leadership.map((lead, idx) => (
                <div key={idx} className="p-6 bg-dim-gray border border-slate-gray/20 rounded-sm">
                  ...
                  <p className="mt-4 text-sm text-pure-white/40 leading-relaxed">{lead.description}</p>
                </div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="space-y-16">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
            viewport={{ once: true }}
            className="pt-12 border-t border-slate-gray/20"
          >
            <h3 className="text-sm font-bold mb-6 uppercase tracking-[0.3em] text-slate-gray font-mono">
              Network Links
            </h3>

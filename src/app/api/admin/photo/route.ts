...
const GITHUB_REPO = 'onlynyxs/website'; // fix: was "Selkie-the-goat/website"
...
// Edge-safe ArrayBuffer → base64 (fix: Buffer is not available in edge runtime)
...
export async function POST(req: NextRequest) {
  ...
  // Prepare the filename based on title
  ...
  // Check if file already exists (need SHA to overwrite, fix: missing SHA check caused 422 on re-upload)
